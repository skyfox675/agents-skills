...
allowed-tools: mcp__figma__get_variable_defs, mcp__figma__get_code_connect_map, mcp__figma__get_code, mcp__figma__get_image, Read, Write, Edit, Glob, Grep, Bash(git rev-parse:*), Bash(git log:*), Bash(git diff:*)
---
