...
Arguments: the text you type after the command — an optional scope (a page, screen flow, or component set; none = the whole file). A `model:` token pins the tier (default `sonnet`).
